...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Detection Learning")
    # common
    ...
    # optimization
    parser.add_argument("--warmup_seg", action="store_true", help="warm up seg MLP by clustering initialization")
    ...
    parser.add_argument("--use_joint_cost", action="store_true", help="use cost to build mst")
